                ...
                <div className="w-full">
                    <div className="flex flex-wrap gap-4 md:flex-nowrap">
                        ...
                        <p className="text-sm text-gray-700 leading-6 w-full md:w-1/2">
                            ...
                            loose-fitting silhouette for
                            comfort . Medium weight cotton,
                            between 145 and 165 g/m2,
                            providing flexibility and
                            strength.. Rounded neck. Short
                            sleeve. The model is wearing a
                            size M. Basics Collection. The
                            model is 183 cm and is wearing a
                            size M. Antoine Griezmann
                            Campaign.Relaxed fit. Cotton
                            fabric. Medium weight cotton
                            fabric. Relaxed fit: straight
                            and loose-fitting silhouette for
                            comfort . Medium weight cotton,
                            between 145 and 165 g/m2,
                            providing flexibility and
                            strength.. Rounded neck. Short
